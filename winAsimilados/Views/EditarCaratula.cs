...
namespace winAsimilados.Views
{
    public partial class EditarCaratula : Form
    {
        ...
        public EditarCaratula(string caratula, string layout, SplashScreenManager splash, string rfcEmpresa)
        {
            nomCaratula = caratula;
            SplashScreen = splash;
            nombreLayout = layout;
            rfc = rfcEmpresa;
            nomina = new V.NominaAsimilados(empresa, rfc, splashScreenManager1);
            InitializeComponent();
            ...
            try
            {
                ...
                if (respuesta.Equals(DialogResult.Yes))
                {
                    ...
                    {                    
                        ...
                        if (controlador.ActualizaCaratula(caratulaPago, splashScreenManager1).Equals(true) && controlador.ActualizaDetalleLayout(detalleLayout, splashScreenManager1).Equals(true) && controlador.ActualizaLayout(listaLayout, splashScreenManager1).Equals(true))
                        {
